...
## Эта небольшой проект, о этапах задачи.

![Главная страница](react/public/github.png)
...
## Цель проекта:
- Практика работы с React, TypeScript, dnd-kit и библиотекой Bootstrap, а также создание небольшого проекта для портфолио. Сайт сохраняет все ваши проекты и задачи в LocalStorage, это нужно чтобы был смысл существования этого проекта.
...
Минимальная комфортная ширина просмотра — 750px.
