...
## Цель проекта:
- Практика работы с React, TypeScript, dnd-kit, а также создание небольшого проекта для портфолио. Сайт сохраняет все ваши проекты и задачи в LocalStorage, это нужно чтобы был смысл существования этого проекта.
